...
You can contribute in many ways: writing code, improving documentation, reporting bugs, requesting features, or creating tutorials and blog posts. Every contribution, large or small, helps make NotchNudge better.
...
Please submit all translations via issues or pull requests. New strings added to the `dev` branch from code changes will be reviewed and integrated as needed.
...
2. **Clone your fork**:
   ...
   ```bash
   git clone https://github.com/{your-username}/nudge.notch.git
   cd nudge.notch
   ```
...
Thank you for contributing to NotchNudge! Your efforts help make this project better for everyone. 🎉
